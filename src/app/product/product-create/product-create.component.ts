...
export class ProductCreateComponent implements OnInit {
  ...
  onSubmit() {
    const product = new Product(this.productForm.value['name'], this.productForm.value['brand'],this.productForm.value['email'],this.productForm.value['quantity'],this.productForm.value['price'], this.productForm.value['image'],null);
