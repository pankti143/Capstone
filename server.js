...
// Local database URI.
const LOCAL_DATABASE = "mongodb+srv://pankti:pankti123@pankticluster.io7lz.mongodb.net/tcsdb?retryWrites=true&w=majority";
// Local port.
...
app.post("/api/userlogin",function(req,res){
    var login= req.body;
    database.collection(LOGIN_COLLECTION).insertOne(login, function (err, doc) {
        if (err) {
